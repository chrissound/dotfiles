...
myKeys conf@XConfig {XMonad.modMask = modm} =
  ...
  ++
            ...
            , ((modm, xK_s), submap . M.fromList $ [ -- special 
            ...
            --
            , ((modm, xK_c), submap . M.fromList $ -- focus specific window and swop it with master
                fmap
                  (\(c, i) ->
            ...
            , ((modm, xK_g), submap . M.fromList $ -- focus specific window
                fmap
                  (\(c, i) ->
                    (singleKey (windowSelection c i), sendMessage $
                      case c of
